...
import { Braces, Clock, Lock, GitCompareArrows, Regex, Image, Shrink, Crop, GalleryHorizontalEnd, QrCode, ScanLine, Music, Scissors, Repeat, Timer } from 'lucide-vue-next'
import type { ToolMeta } from '../types/tool'

const props = defineProps<{ tool: ToolMeta }>()

const iconMap: Record<string, Component> = {
  Braces, Clock, Lock, GitCompareArrows, Regex, Image, Shrink, Crop, GalleryHorizontalEnd, QrCode, ScanLine, Music, Scissors, Repeat, Timer,
}
